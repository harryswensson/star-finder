...
* `starfinder` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `starfinder` - executable or bundle name on disk.
* `starfinder` - display name shown in window titles and about app dialogs.
